        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="tambah.php" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block" name="proses" value="proses">Tambahkan</button>
                    <a type="button" class="btn btn-primary btn-user btn-block" href="barang.php" name="kembali"
