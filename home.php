      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
              ...
              ?>
                ...
                <a href="barang.php" class="btn btn-primary btn-block">Lihat data barang</a>
             </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
              ...
              <?php
                ...
                <h4><?= $user['jmlUser']; ?></h4>
                <a href="user.php" class="btn btn-primary btn-block">Lihat data user</a>
             </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
              ...
              <?php
                ...
                <a href="peminjaman.php" class="btn btn-primary btn-block">Lihat data peminjaman</a>
             </div>
        </div>
      </div>
    </div>  
